...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO menu (id, nama, berkas) VALUES ('$id', '$nama', '$file_name')";
...
<body>
    <div class="classedit">
    <h1>Tambah PDF</h1>
    <form action="tambah_pdf.php" method="post" enctype="multipart/form-data">
...
<select name="id" id="id" required>
    <option value="" disabled selected>Select an ID</option>
        ...
        <br>
        <input type="submit" value="Tambah PDF">
    </form>
    </div>
    <script>
